...
class AddProductActivity : AppCompatActivity(), IPickResult {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_add.setOnClickListener {
            ...
            Toast.makeText(this,"$name, $description, $amount ,$price, $rating, $spinner ",Toast.LENGTH_LONG).show()
            db.addProduct(name,description,amount.toInt(),price.toDouble(),0,ImageURI.toString(),rating.toInt(),spinner)
           finish()
        }
